...
func TestGetConfigPath(t *testing.T) {
	...
	got := GetConfigPath()
	want := filepath.Join("/tmp/home", ".ectoclaw", "config.json")

	assert.Equal(t, want, got)
}

func TestGetConfigPath_WithECTOCLAW_HOME(t *testing.T) {
	t.Setenv("ECTOCLAW_HOME", "/custom/ectoclaw")
	t.Setenv("HOME", "/tmp/home")

	got := GetConfigPath()
	want := filepath.Join("/custom/ectoclaw", "config.json")

	assert.Equal(t, want, got)
}

func TestGetConfigPath_WithECTOCLAW_CONFIG(t *testing.T) {
	t.Setenv("ECTOCLAW_CONFIG", "/custom/config.json")
	t.Setenv("ECTOCLAW_HOME", "/custom/ectoclaw")
	t.Setenv("HOME", "/tmp/home")
...
func TestGetConfigPath_Windows(t *testing.T) {
	...
	got := GetConfigPath()
	want := filepath.Join(testUserProfilePath, ".ectoclaw", "config.json")
...
func TestGetConfigPath_WithEnv(t *testing.T) {
	t.Setenv("ECTOCLAW_CONFIG", "/tmp/custom/config.json")
