...
func skillsInstallFromRegistry(cfg *config.Config, registryName, slug string) error {
	...
	registryMgr := skills.NewRegistryManagerFromConfig(skills.RegistryConfig{
		MaxConcurrentSearches: cfg.Skills.MaxConcurrentSearches,
		ClawHub:               skills.ClawHubConfig(cfg.Skills.Registries.ClawHub),
	})
...
func skillsInstallBuiltinCmd(workspace string) {
	builtinSkillsDir := "./ectoclaw/skills"
...
func skillsListBuiltinCmd() {
	...
	builtinSkillsDir := filepath.Join(filepath.Dir(cfg.WorkspacePath()), "ectoclaw", "skills")
