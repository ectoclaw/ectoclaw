...
// OutboundMessage carries a response from the agent to a channel.
// Parts optionally contains media attachments — the channel decides how to present them
// alongside Content (e.g. photo+caption, separate messages, or fallback text).
