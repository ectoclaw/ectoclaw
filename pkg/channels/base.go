...
func (c *BaseChannel) HandleMessage(
	...
	// Auto-trigger typing indicator and message reaction before publishing.
	// Each capability is independent — both may fire for the same message.
...
// SetStateRecorder injects a StateRecorder into the channel.
func (c *BaseChannel) SetStateRecorder(r StateRecorder) {
	c.stateRecorder = r
}
