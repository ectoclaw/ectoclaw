...
CONTAINER_NAME="ectoclaw-test-ergo"
IRC_PORT=6667
...
echo ""
echo "Add this to your ~/.ectoclaw/config.json under \"channels\":"
echo ""
echo '  "irc": {'
echo '    "enabled": true,'
...
echo '  }'
echo ""
echo "Then run ectoclaw:"
echo "  cd packages/ectoclaw && go run ./cmd/ectoclaw gateway"
echo ""
